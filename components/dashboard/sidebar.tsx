...
export function DashboardSidebar({ user }: SidebarProps) {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="flex items-center gap-2.5 px-5 h-16 border-b flex-shrink-0" style={{ borderColor: "#eeebe6" }}>
        <div
        ...
        <span className="font-bold text-[#111] tracking-tight text-base">Hiro</span>
      </div>
      ...
      {/* User footer */}
      <div className="p-3 border-t flex-shrink-0" style={{ borderColor: "#eeebe6" }}>
        <div
        ...
        >
          ...
          <Button
            variant="ghost"
            size="icon"
            className="w-7 h-7 flex-shrink-0 text-[#bbb] hover:text-red-500 hover:bg-red-50"
